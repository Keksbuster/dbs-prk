...
INSERT INTO person (nr, name, vorname, geburt, abteilungnr, gehalt, ort) SELECT nr, name, vorname, CAST(geburt AS DATE), abteilungnr, CAST(gehalt AS FLOAT), ort FROM import;
